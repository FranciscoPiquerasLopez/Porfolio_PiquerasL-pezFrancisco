...
window.addEventListener('scroll', function () {
    if (window.scrollY > 0) {
        document.getElementById('backgroundHeader').classList.add('bg-white', 'bg-opacity-50', 'backdrop-blur-3xl', 'py-2', 'px-5');
    } else {
        document.getElementById('backgroundHeader').classList.remove('bg-white', 'bg-opacity-50', 'backdrop-blur-3xl', 'py-2', 'px-5');
    }
